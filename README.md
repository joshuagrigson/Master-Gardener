...
- **The Master Gardener.** Every plant gets a read without you tagging anything: a headline verdict, what the plant is doing physiologically right now, what to do this week, what to watch for, heat units against the crop's typical requirement, and season, rotation and companion notes. The Gardener tab opens with a prioritized garden check across all beds, plus what still fits the remaining season. The knowledge is `gardener.js`.
